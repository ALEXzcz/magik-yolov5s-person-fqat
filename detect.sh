...
# 4bit
python detect.py --source data/anytrek_detect --float_model checkpoint/32W32F/weights/best.pt --weights ./checkpoint/4W4F/weights/best.pt --imgs 640 --device 0 --view-img --bit 4
